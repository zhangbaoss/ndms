...
public class AuthController {
    ...
    public @ResponseBody
    Response accountLogin(HttpServletRequest request, HttpServletResponse response, @RequestBody AccountLoginArgument args) {
        /*
    ...
    public @ResponseBody
    Response phoneLogin(HttpServletRequest request, HttpServletResponse response, @RequestBody PhoneLoginArgument argument) throws Exception {
        argument.validate();
    ...
    public @ResponseBody
    Response wxLogin(HttpServletRequest request, HttpServletResponse response, @RequestBody WxLoginArgument argument) throws Exception {
        argument.validate();

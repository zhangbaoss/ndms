...
@ServerEndpoint(value = "/pc/controller")
public class WsPcControllerServer extends WsServer {
    static String PEER_TYPE = "pc-controller";
    // "/pc/controller?nuid=gggg&ndid=ggg&access-token=xxx&secret-key=gggg"

    public WsPcControllerServer() {
        super(PEER_TYPE);
    }
